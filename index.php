...
<html class="loading">
  <head>
    ...
    <title>Telegram - @Wifiexploiter</title>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					...
					<h4 class="mb-2"><strong>TIKTAK CHECKER</strong></h4>

					<textarea rows="8" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CARDS HERE"></textarea>
					
					          <select name="gate" id="gate" class="form-control" style=" width: 100%; margin-bottom: 1px;">
					            
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/api.php">AUTH</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/api3.php"> NEW </option>
...
<footer>
  <p>Channel - <a href="https://t.me/wifiexploiter"> TIKTAK</a> </p>
  <p>
    𝙏𝙃𝙄𝙎 𝙄𝙎 𝙁𝙊𝙍 𝙀𝘿𝙐𝘾𝘼𝙏𝙄𝙊𝙉𝘼𝙇 𝙋𝙐𝙍𝙋𝙊𝙎𝙀𝙎. 𝙏𝙃𝙄𝙎 𝘾𝙃𝙀𝘾𝙆𝙀𝙍 𝙄𝙎 𝙈𝘼𝘿𝙀 𝘽𝙔 𝙏𝙄𝙆𝙏𝘼 𝘼𝙆𝘼 𝙒𝙄𝙁𝙄𝙀𝙓𝙋𝙇𝙊𝙄𝙏𝙀𝙍 𝙊𝙉 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈. 𝙒𝙀 𝘿𝙊 𝙉𝙊𝙏 𝙏𝙊𝙇𝙀𝙍𝘼𝙏𝙀 𝙁𝙍𝘼𝙐𝘿 𝙊𝙍 𝘼𝙉𝙔 𝙊𝙏𝙃𝙀𝙍 𝙄𝙇𝙇𝙀𝙂𝘼𝙇 𝘼𝘾𝙏𝙄𝙑𝙄𝙏𝙄𝙀𝙎.
     </p>
...
swalWithBootstrapButtons.fire({
  title: "WELCOME TO TIKTAK Checker", 
  text: "Add tiktak for questions",
  icon: 'warning',
  showCancelButton: true,
  confirmButtonText: 'Click To Add tiktak',
  cancelButtonText: 'Already have tiktak added',
  reverseButtons: false
}).then((result) => {
  if (result.isConfirmed) {
    Swal.fire({
      title:'Redirecting.',
      text:'You are now being redirected towards tiktak, make sure to not ask stupid questions!',
      timer: 1500,
...
function RedirectUrl(){    
       window.location.href ="https://t.me/wifiexploiter";
    }
...
if(total > 1000000){
  Swal.fire({title: 'YOU CAN NOT PERFORM THAT ACTION: REDUCE NUMBER OF CARDS TO < 1000000', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
